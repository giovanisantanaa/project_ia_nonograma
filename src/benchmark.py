"""Rotina de benchmark para executar agentes sobre um conjunto de puzzles.

O módulo executa cada agente em cada puzzle e retorna métricas como tempo,
passos e se foi resolvido. Não alterei a lógica, apenas adicionei este
comentário em PT-BR para facilitar leitura.
"""
